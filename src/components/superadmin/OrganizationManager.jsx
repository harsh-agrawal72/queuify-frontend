                                                ...
                                                <td className="px-6 py-4">
                                                    {orgPlan ? (
                                                        <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold border ${
                                                            ...
                                                            : orgPlan.name === 'Standard' || orgPlan.name === 'Starter'
                                                            ? 'bg-blue-50 text-blue-700 border-blue-200'
                                                            : 'bg-amber-50 text-amber-700 border-amber-200'
                                                        }`}>
                                                            <CreditCard className="h-3.5 w-3.5" /> 
                                                            {orgPlan.name.toUpperCase()}
                                                        </span>
                                                    ) : (
                                                        <span className="inline-flex items-center gap-1 px-2 py-1 rounded-lg text-[10px] font-bold bg-red-50 text-red-600 border border-red-100 uppercase tracking-tighter">
                                                            No Active Plan
                                                        </span>
                                                    )}
                                                </td>
